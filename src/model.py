...
class MyModel:
    ...
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            ...
            device_map="auto",                           # <-- let HF auto-place layers
            max_memory={0: "18GB", "cpu": "50GB"},
            offload_folder="offload",                   # <-- where to store CPU weights
    ...
    def run_pred(self, data):
        ...
        for idx, prompt in enumerate(data):
            ...
            # Truncate to max byte context if needed
            ...
            # Decode only the generated byte (not the prompt)
            next_token = output_ids[0, -1:]  # just the new token
